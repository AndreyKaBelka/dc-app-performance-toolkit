...
class UrlManager:
    ...
    def __init__(self, issue_key=None, issue_id=None, project_key=None, jql=None, projects_list_page=None, board_id=None, page_key=None):
        ...
        self.page_edit_url = f"/wiki/p/{project_key}/view/{page_key}/1/edit"
