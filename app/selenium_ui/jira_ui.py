...
def test_1_selenium_tasklist_create_tasks(jira_webdriver, jira_datasets, jira_screen_shots):
    extension_ui.tasklist_create_tasks(jira_webdriver, jira_datasets)


def test_1_selenium_tasklist_delete_tasks(jira_webdriver, jira_datasets, jira_screen_shots):
    extension_ui.tasklist_delete_tasks(jira_webdriver, jira_datasets)


def test_1_selenium_tasklist_edit_tasks(jira_webdriver, jira_datasets, jira_screen_shots):
    extension_ui.tasklist_edit_tasks(jira_webdriver, jira_datasets)
